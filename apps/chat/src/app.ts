...
// Reads one public home page over HTTPS. The custom lookup keeps a domain that
// resolves to a loopback or private address from reaching internal services,
// and redirects may not leave the requested domain.
